...
class EmploymentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create employment" do
    assert_difference("Employment.count") do
      post employments_url, params: { employment: { bio: @employment.bio, email: @employment.email, name: @employment.name } }
    end
  ...
  test "should update employment" do
    patch employment_url(@employment), params: { employment: { bio: @employment.bio, email: @employment.email, name: @employment.name } }
